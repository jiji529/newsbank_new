			...
			<dl>
				...
				<dd id="2">
					<p>
						...
						* 뉴스뱅크 세금계산서 담당자<br />
						- 당담자명 : 신윤철 팀장<br />
						- 전화 : 02-593-4174(내선번호 204)<br />
						- 팩스 : 02-593-4175<br />
						- 이메일 : cool672@dahami.com<br />
				...
				<dd id="3">
					<p>
						뉴스뱅크의 고객상담 전화번호는 02-593-4174(내선번호 204)입니다.<br />
				...
				<dd id="6">
					<p>
						사이트 오른쪽 상단 ‘마이페이지’의 ‘다운로드’ 페이지에서 다운로드 가능합니다.<br />
				...
				<dd id="8">
					<p>
						...
						비밀번호는 웹사이트 상단 "마이페이지 → 계정관리" 에서 변경하실 수 있습니다. <br />
					</p>
				</dd>
				...
				<dd id="10">
					<p>
						회원 탈퇴를 원하는 회원은 뉴스뱅크 담당자 이메일(jjunghyo2@dahami.com)로 아래의 내용을 적어 보내주시기 바랍니다.<br />
						1.뉴스뱅크이미지 회원 아이디<br />
						2.회원 이름<br />
						3.연락처<br />
					</p>

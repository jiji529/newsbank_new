...
<div class="wrap">
	...
	<section class="mypage" id="info_table">
		...
		<table class="tb01" cellpadding="0" cellspacing="0">
			...
			<tbody>
				<tr>
					<th>아이디 <em class="ico ico_require">필수항목</em> </th>
					<td> jjunghyo2</td>
				</tr>
				<tr>
					<th> 비밀번호 변경 </th>
					<td><input type="password"  class="inp_txt"   value="password"  size="40" ></td>
				</tr>
				<tr>
					<th>비밀번호 재확인</th>
					<td><input type="password"  class="inp_txt"   value="password"  size="40" ></td>
				...
				<tr>
					<th>이름</th>
					<td><input type="text"  class="inp_txt"   value="" size="40"></td>
				</tr>
				<tr>
					<th>휴대전화</th>
					<td class="phone"><select name="" class="inp_txt" style="width:70px;">
						...
						<!-- 수정 누르면 보이는 -->
						<div class="edit_phone"> <span class="edit_phone_txt">변경할 휴대전화</span>
							...
							<div class=""> <span class="edit_phone_txt">인증번호 입력</span>
								<input type="text" size="40"  class="inp_txt" value="" maxlength="4" />
								<a href="#" class="btn_input1">확인</a> </div>
						</div>
						<!-- 여기까지 --></td>
				</tr>
				<tr>
					<th>이메일</th>
					<td><input type="text" class="inp_txt" size="80" /></td>
				</tr>
			</tbody>
		</table>
		<h4>법인 정보</h4>
		<table class="tb01" cellpadding="0" cellspacing="0">
			...
			<tbody>
				...
				<tr>
					<th>사업자등록번호</th>
					<td><input type="text"  size="3"  class="inp_txt" value="111" maxlength="3">
						<span class=" bar">-</span>
						<input type="text" size="2"  class="inp_txt" value="12" maxlength="2">
						<span class=" bar">-</span>
						<input type="text" size="5"  class="inp_txt" value="49789" maxlength="6" />
						<a href="#" class="btn_input1">등록증 업로드</a> <a href="#" class="btn_input1">다운로드</a></td>
				</tr>
				<tr>
					<th>사무실 전화</th>
				...
				<tr>
					<th>정산 매체</th>
					<td><input type="file"  />
						<a href="#" class="btn_input1">매체선택</a><a href="#" class="btn_input1">제호업로드</a><a href="#" class="btn_input1">다운로드</a>
						<a class="file_add">파일 추가</a><a class="file_del">파일 삭제</a></td>
				</tr>
			</tbody>
		</table>

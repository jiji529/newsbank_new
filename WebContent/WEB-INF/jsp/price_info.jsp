            ...
            <section id="tblEditorialNYT" style="display: none;">
	             ...
	             <table class="tb01" cellpadding="0" cellspacing="0">
	                 ...
	                 <tbody>
	                     ...
	                     <tr id="r31">
	                         <td rowspan="4">온라인</td>
	                         <td rowspan="2">기업 및 단체 운영의 홈페이지 또는 블로그, 인트라넷, 내부게시판 등</td>
	                         <td>6개월 이내</td>
	                         <td>110,000</td>
	                     </tr>
	                     <tr id="r31-2">	                         
	                     ...
	                     <tr id="r32">
	                         <td rowspan="2">웹진, 뉴스레터 온라인배포용</td>
	                         <td>6개월 이내</td>
	                         <td>110,000</td>
	                     </tr>
	                     <tr id="r32-2">

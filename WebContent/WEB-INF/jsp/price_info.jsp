            ...
            <section id="tblEditorialNYT" style="display: none;">            	
            	<!-- 가격테이블 -->
	             <table class="tb01" cellpadding="0" cellspacing="0">
	                 ...
	                 <tbody>
	                     <tr id="r1">
	                         <td><b>인쇄물</b><br>(신문, 잡지, 교과서, 참고서, 도감, 의정보고서, 논문 등)</td>
	                         <td><b>발행 부수(Circulation)</b> 또는 <b style="float: none;">출간 횟수(Edition)</b> 에 따라 가격 결정</td>
	                         <td>\ 99,000<br>
(1회 인쇄 기준)</td>
	                     </tr>
	                     <tr id="r2">
	                         <td><b>디지털 미디어</b><br>(광고/상업/판촉 목적 제외한 온라인 및 디지털 미디어 게재)</td>
	                         <td><b>6개월 단위, 최대 1년까지 계약 가능</td>
	                         <td>\ 99,000<br>
(6개월 게시 기준)</td>
	                     </tr>			                        
	                 </tbody>
	          ...
	          <div class="price_mess">
				① <b class="color">모든 계약 건</b>은 뉴욕타임스와 직접적인 <b class="color">가격 협상</b>이 필요하므로 <a href="/contact" target="_blank" style="text-decoration: underline; font-weight: bold; color: #111;">뉴스뱅크 고객센터</a>로 문의해주세요.<br>

...
<body>	
	<div class="wrap">
		...
		<div class="main">
			...
			<div class="center">
				<h2>뉴스뱅크가 엄선한 사진</h2>
				<p>수백명의 보도사진 작가가 현장을 누비며 대한민국과 세계의 오늘을 담고 있습니다.</p>
				<div class="tab">
					<ul class="tabs">
						<li>
			...
			<div class="center">
				<div class="serv_txt_l">
					...
					<p>뉴스뱅크는 국내외 ${fn:length(mediaList)}개 언론사의 보도사진 <span class="totalNumberPhoto"></span> 컷 이상을 보유하고 있는 국내 최대의 보도사진 통합 라이브러리입니다.<br />
						신미양요, 병인양요의 19세기 사진을 비롯해 일제 강점기를 지나 6.25 전쟁을 거치고<br />
						산업화와 민주화 시대를 거쳐 오늘에 이르기까지 <br />대한민국 근현대사의 중요 장면이 생생한 보도사진으로 기록되어 남아 있습니다. <br/>
						또한, 세계 각지의 역사적 순간과 주요 사건을 담은 뉴욕타임스의 사진들도 제공받아 <br/> 전 세계의 중요한 장면들을 아우르는 방대한 보도사진 아카이브를 구축하고 있습니다.</p>
				</div>
			</div>
			</section>
			<!--서비스소개-->

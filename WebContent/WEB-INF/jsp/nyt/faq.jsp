			...
			<body>
			    ...
			    <jsp:include page="./common/headerKR2.jsp"/>
			        <section class="mypage">
			            ...
			            <div class="faq">
			                <dl>
                    <dt id="dt1" class="" style="display: none;"><a onclick="evt('1')"><span class="faq_tit">뉴스뱅크에 사진 콘텐츠를 제공하고 싶습니다.</span><span class="faq_ico"></span></a></dt>
                    ...
                    <dt id="dt4" class=""><a onclick="evt('4')"><span class="faq_tit">가상계좌로 결제했습니다. 입금확인은 언제 되나요?</span><span class="faq_ico"></span></a></dt>
		...
		<html lang="en">
			...
			<body>
			    <div class="wrap">
                    ...
                    <dt id="dt3"  style="display: none;"><a onclick="evt('3')"><span class="faq_tit">I'd like to contact by phone.
                            </span><span class="faq_ico"></span></a></dt>
                    ...
                    <dt id="dt4" class="" style="display: none;"><a onclick="evt('4')"><span class="faq_tit">I paid with a virtual account, when will my payment be confirmed?
                            </span><span class="faq_ico"></span></a></dt>
                    <dd id="4" style="display: none;">
                        <p>
                    ...
                    <dt id="dt5" class="" style="display: none;"><a onclick="evt('5')"><span class="faq_tit">What are the different ways to pay for content?
                            </span><span class="faq_ico"></span></a></dt>
                    ...
                    <dt id="dt6" class="" style="display: none;"><a onclick="evt('6')"><span class="faq_tit">Where can I download the content I paid for?
                            </span><span class="faq_ico"></span></a></dt>
                    <dd id="6" style="display: none;">
                        <p>

		...
		<tbody>
			...
			<tr>
				...
				<td>
					...
					<ul id="customDayOption" class="period" style="margin-left : 0px;">
					...
					<select name="startYear" class="inp_txt" style="width:100px; margin-left : 15px;" onchange="setYearOfMonth(this)">
						<c:forEach var="i" begin="2015" end="${year}" step="1">
							<option value="${i }" <c:if test="${i eq year}">selected</c:if>>${i}년</option>
						</c:forEach>
					</select>
			...
			<tr>
				<th>매체</th>
				<td>
				<select name="" id="adjMaster" class="inp_txt"
					style="width: 150px;">

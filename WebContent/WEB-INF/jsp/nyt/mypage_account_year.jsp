...
<script src="js/nyt/mypage.js?v=20180308"></script>
...
<body>
	<div class="wrap">
				...
				<tbody>
					...
					<th>기간별 조회</th>
						<td>
							...
							<div class="period">
								<input type="text"  size="12" id="contractStart" name="start_date"  class="inp_txt" value="${year}-01-01" maxlength="10" disabled>
								<span class=" bar">~</span>
								<input type="text"  size="12" id="contractEnd" name="end_date"  class="inp_txt" value="${today }" maxlength="10" disabled>
							</div>
						</td>
					</tr>
		...
		<div class="btn_area" style="margin-top: 0;">
			<a href="javascript:;" class="btn_input2" id="btnaccountYearSearch">검색</a>
		</div>
		<a href="javascript:;" onclick="excelDown('/excel.account.api', 'accountyear')" style="float: right; padding: 10px 15px; font-size: 13px; border-radius: 2px; color: #666; border: 1px solid #aaa; margin-top: -20px;">엑셀 다운로드</a>
